    ...
    _ = {
      ...
      filter: function() {
        return function(obj, iterator, context) {
          ...
          return obj.filter(iterator, context)(nativeFilter && obj.filter === nativeFilter ? (_.each(obj, function(value, index, list) {
    ...
    Popup = (function(_super) {
      ...
      Popup.prototype.close = function() {
        ...
        setTimeout((function(_this) {
          return function() {
            ele.hide();
            return options.callback && options.callback.call(_this);
          };
        })(this), 300);
        ...
        if (cityArray) {
          map = {
            '1': function(c) {
              ...
              return json['1'][c.province_name][c.city_level] = (json['1'][c.province_name][c.city_level] || []).concat(c.city_name);
            },
            '2': function(c) {
              return json['2'] = (json['2'] || []).concat(c.city_name);
            },
            '3': function(c) {
              return json['3'] = (json['3'] || []).concat(c.country_name);
            }
          };
      ...
      CitySelection.prototype.provinceChange = function(oT) {
        ...
        if (oT) {
          ...
          if (id = this.data.province) {
            ...
            oP = this.oTarget.parent();
            iT = this.oTarget.offset().top + this.oTarget.height();
            if (iT < oP.scrollTop()) {
              oP.scrollTop(iT);
